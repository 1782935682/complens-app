...
上述命令分别生成 `src/data/gb2760OfficialFullText.js`、`src/data/gb2760OfficialGeneratedA1Staging.js` 和 `src/data/gb2760OfficialReferenceTables.js`，保存官方 PDF 全 264 页逐页文本、表 A.1 行级 staging，以及 2799 行官方参考表结构化数据。后端 `npm run db:seed` 会同时导入：

...
assert.match(serviceWorkerJs, /CACHE_VERSION = 'compcheck-shell-v23'/);
assert.match(serviceWorkerJs, /RUNTIME_CACHE = 'compcheck-runtime-v23'/);
assert.match(serviceWorkerJs, /IMAGE_CACHE = 'compcheck-images-v23'/);
...
assert.match(serviceWorkerJs, /staleWhileRevalidate\('\.\/index\.html', request, CACHE_VERSION\)/);

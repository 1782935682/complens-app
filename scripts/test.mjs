...
assert.equal(gb2760OfficialFAdditiveIndexRows.length, 285);
assert.equal(gb2760OfficialReferenceRows.length, 2798);
...
assert.equal(gb2760ReferenceSummary.totalRows, 2798);
...
assert.equal(gb2760ReferenceSummary.fAdditiveIndexCount, 285);
...
assert.equal(gb2760ReferenceQualityReport.totalRows, 2798);
...
assert.equal(gb2760ReferenceQualityReport.fAdditiveIndexCount, 285);

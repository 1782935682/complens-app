...
assert.match(serviceWorkerJs, /CACHE_VERSION = 'compcheck-shell-v12'/);
...
assert.match(serviceWorkerJs, /\.\/data\/legalContent\.js/);
assert.match(serviceWorkerJs, /\.\/data\/membershipPlans\.js/);
assert.match(serviceWorkerJs, /\.\/data\/searchAliases\.js/);
...
assert.match(serviceWorkerJs, /\.\/pages\/legalPage\.js/);
...
assert.match(renderRoute(resolveRoute('#/food/ingredient/citric-acid')), /已加入对比/);

...
8. GB 2760-2024 官方标准文本来源已从食品安全国家标准数据检索平台确认：标准文本 ID `6CA1489A-9570-4906-8CE8-CC86FBFB1941`，附件 ID `43C9B75E-3D84-4577-80FC-0F7D77D36407`，发布日期 `2024-02-08`，实施日期 `2025-02-08`。
9. `DATA_SOURCES.md`、`PROJECT_PLAN.md`、`CODEX_TASKS.md` 已同步新口径：基础权威库 + 持续扩充 + 人工校验队列。
...
| GB 2760 条款级法规依据 | 0 条已验证 | 尚未导入逐添加剂条款编号、食品类别和限量；不得展示为 GB 2760 已验证 |
...
| 阻塞项 | 需要确认 |
|---|---|
| GB 2760 条款级核验 | 条款编号、食品类别、最大使用量、原文片段 |
...
`npm run validate:data` 输出：112 条食品记录；`verified_regulation=0`、`verified_jecfa=32`、`common_ingredient=12`、`unverified=68`、`missingSourceFields=0`、`missingUsageLimits=100`。

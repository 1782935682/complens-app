...
| 项目 | 数量 |
|---|---:|
| ingredient_master | 2005 |
| ingredient_source_relations -> current | 2017 |
| ingredient_regulatory_rules -> current | 133 |
| nutrition_fortifier_rules -> current | 0 |
| novel_food_ingredient_rules -> current | 0 |
| food_medicine_rules -> current | 0 |
| microorganism_strains -> current | 0 |
...
| reason | 数量 |
|---|---:|
| GB 2760 C.3 enzyme source/donor references remain non-food microorganism records | 81 |

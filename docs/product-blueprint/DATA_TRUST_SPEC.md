...
1. 默认展示：我的关注项、重点提醒、配料数量、添加剂数量、糖/钠/脂肪/蛋白质等标签信息、暂未识别/暂未收录提示。
...
消费者报告禁止输出“可以买 / 不能买 / 健康 / 不健康 / 安全 / 有害 / 致癌 / 治疗 / 诊断 / 一定过敏”。推荐使用“建议关注 / 更适合重点查看 / 部分人群可能需要留意 / 信息不足，请补充标签文字后查看结果 / 仅供标签信息参考，不构成医疗或营养诊断”。
